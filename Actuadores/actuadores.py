...
if __name__ == "__main__":
  ...
  ligths_port = [0,1] #GPIO de lámparas
  motors_port = 2 #GPIO de motores
  pumps_port = 3 #GPIO de la bomba
  ...
  client.username_pw_set('kIj8grkE1XTMirfxSEdJ')
  client.connect('155.138.133.71', port=1883, 60)
  client.loop_start()
  time.sleep(1)
